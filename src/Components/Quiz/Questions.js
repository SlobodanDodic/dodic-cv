export const questions = [
  ...
  {
    questionText: "The founder of Fender company was?",
    answerOptions: [
  ...
  {
    questionText: "Who said the famous line: `You shall not pass`?",
    answerOptions: [
      { answerText: "Gandalf the White", isCorrect: false },
      { answerText: "Your math professor", isCorrect: false },
      { answerText: "Gandalf the Grey", isCorrect: true },
      { answerText: "Retiree waiting in line", isCorrect: false },
    ],
  },
  {
